...
Do something while during another activity.
...
If you add this to the application, you'll get:
	...
	bash$ perl example_05_add_help.pl
...
C<description> text is shown in the full help for the command:
    ...
    bash $perl example_06_add_help_text.pl
...
of arguments (L<M6::CLI::Argument::Int>).
...
=head1 COMBINING ARGUMENTS AND SUB-COMMANDS
